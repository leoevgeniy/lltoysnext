        ...
        <>
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Введите последние 4 цифры сходящего номера</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form.Control
            ...
            <Container className='login w-100 p-3'>
                ...
                <Form onSubmit={submitHandler}>
                    <p className='text-center fw-bold mt-3 text-white' style={{'fontSize': '20px'}}>Как Вас зовут </p>
                    ...
                    <p className='text-center fw-bold mt-3 text-white' style={{'fontSize': '20px'}}> Ваш email
