...
// import './MultiRangeSliderold.css';
// import './MultiRangeSliderBlack.css';

const MultiRangeSliderold = ((props) => {
    ...
    return (
        <div className={baseClassName} onWheel={onMouseWheel} ref={ref}>
            <div className='bar' ref={refThis}>
                ...
                <input className='input-type-range input-type-range-min' type='range' min={min} max={max}
                       step={step} value={minValue} onInput={onInputMinChange}/>
                <div className='thumb thumb-left' onMouseDown={onLeftThumbMousedown}
                ...
                <input className='input-type-range input-type-range-max' type='range' min={min} max={max}
                       step={step} value={maxValue} onInput={onInputMaxChange}/>
                <div className='thumb thumb-right' onMouseDown={onRightThumbMousedown}
            ...
            <div className='d-flex justify-content-between'>
                <div className='w-50 d-flex justify-content-start'>
                    <p className='text-white fs-6' style={{}}>от</p>
                    <input type='text' placeholder={minValue} className={''} style={{width: '60%'}}></input>
                </div>
                <div className='w-50 d-flex justify-content-end'>
                    <p className='text-white fs-6' style={{}}>до</p>
                    <input type='text' placeholder={maxValue} className={''} style={{width: '60%'}}></input>
                </div>
            </div>
...
export default MultiRangeSliderold;